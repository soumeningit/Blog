...
//   return (
//     <div className="flex flex-col items-center justify-center p-2 rounded-md h-screen">
//       <div>
//         <h1>Your Blog</h1>
...
function Dashboard() {
  ...
  return (
    <div className="flex flex-col items-center p-4 h-screen overflow-y-auto">
      <h1 className="text-2xl font-semibold mb-4">Your Blog</h1>
