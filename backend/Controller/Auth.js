...
exports.sendOTPController = async (req, res) => {
    try {
        ...
        let generatedOtp = await otpGenerator.generate(4, {
...
exports.signUpController = async (req, res) => {
    try {
        ...
        console.log("email in db ", recentOtp[0].email, " email in req ", email, "otp in db ", recentOtp[0].otp, " otp coming from req ", otp)
        ...
        console.log("Profile Details : ", profilesDetails);
    ...
    try {
        ...
        if (isMatchedPassword) {
            ...
            const payload = {
                ...
                additionalDetails: user.additionalDetails._id
            }
            ...
            userData.additionalDetails = user.additionalDetails._id;
            data.user = userData;
            user.token = token;
            user.password = null;
